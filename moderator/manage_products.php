...
document.addEventListener('DOMContentLoaded', function () {
    ...
    confirmButton.addEventListener('click', function () {
            ...
            if (data.success) {
                ...
                if (row) {
                    ...
                    if (currentActionType === 'hide') {
                        ...
                        currentActionType = 'show'; // Update for next potential click
                ...
                // setTimeout(() => location.reload(), 1500); // NO LONGER NEEDED
            } else {
        ...
        .finally(() => {
            ...
            // currentProductId = null; // Keep these if modal might be reused without re-triggering button click
